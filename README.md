...
- **Text Tablet** — Freeform rich text editor
- **Drawing Stone** — Freehand canvas with multiple pigments and stroke widths
- **Seals** — Version snapshots. Every seal is a point you can return to.
- **Strata** — Visual timeline of your seals along the bottom of the screen
- **Rivers** — Branch your work. Maintain parallel versions of the same document.
- **Palimpsest** — Diff view. Compare any two seals. Text changes highlighted, older canvas ghosted beneath the new.
